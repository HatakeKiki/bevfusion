...
from mmdet3d.models.utils.transfusion_utils import clip_sigmoid
from mmdet3d.models.utils.basic_block_2d import BasicBlock2D
from mmdet3d.models.utils.transfusion_utils import PositionEmbeddingLearned, TransformerDecoderLayer
from .target_assigner.hungarian_assigner import HungarianAssigner3D
from mmdet3d.utils import loss_utils
from mmdet3d.models.utils import centernet_utils
from mmdet3d.models.utils import model_nms_utils
...
class DSVTHead(nn.Module):
    """
        This module implements DSVTHead.
    ...
    def __init__(
        ...
        self.loss_cls_weight = loss_weights['cls_weight']
        self.loss_bbox = loss_utils.L1Loss()
        self.loss_bbox_weight = loss_weights['bbox_weight']
        self.loss_heatmap = loss_utils.GaussianFocalLoss()
        self.loss_heatmap_weight = loss_weights['hm_weight']
        self.loss_iou_rescore_weight = loss_weights['loss_iou_rescore_weight']
    ...
    def get_targets_single(self, gt_bboxes_3d, gt_labels_3d, preds_dict):
        ...
        target_assigner_cfg = self.target_assigner_config
