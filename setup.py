...
if __name__ == "__main__":
    setup(
        ...
        ext_modules=[
            ...
            # ),
            # make_cuda_ext(
            #     name='roiaware_pool3d_dsvt_cuda',
            #     module='mmdet3d.ops.roiaware_pool3d_dsvt',
            #     sources=[
            #         'src/roiaware_pool3d.cpp',
            #         'src/roiaware_pool3d_kernel.cu',
            #     ]
            ...
            # make_cuda_ext(
            #     name="depth_attn_ext",
            #     module="mmdet3d.ops.depth_attn",
            #     sources=[
            #         "src/depth_attn.cpp",
            #         "src/depth_attn_cuda.cu",
            #     ],
            # ),
            # make_cuda_ext(
            ...
            # make_cuda_ext(
            #     name="index_feat_ext",
            #     module="mmdet3d.ops.index_feat",
            #     sources=[
            #         "src/index_feat.cpp",
            #         "src/index_feat_cuda.cu",
            #     ],
            # ),
